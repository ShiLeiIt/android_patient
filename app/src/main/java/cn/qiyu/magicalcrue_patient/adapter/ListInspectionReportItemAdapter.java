...
public class ListInspectionReportItemAdapter extends BaseAdapter {

    private Context mContext;
    private List<InspectionReportBean> items;
    private Activity activity;
    private InspectionReportBean itemEntity;
    private ViewHolder holder;


    public ListInspectionReportItemAdapter(Context ctx, Activity activity, List<InspectionReportBean> items) {
        this.items=items;
        this.mContext = ctx;
        this.items = items;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //备注
        if (TextUtils.isEmpty(itemEntity.getInspection_description())) {
            holder.tv_context.setText("暂无");
        }else{
            holder.tv_context.setText(itemEntity.getInspection_description());
        }
