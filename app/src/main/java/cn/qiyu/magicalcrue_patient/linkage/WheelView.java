...
package cn.qiyu.magicalcrue_patient.linkage;
...
import cn.qiyu.magicalcrue_patient.linkage.OnWheelChangedListener;
import cn.qiyu.magicalcrue_patient.linkage.OnWheelScrollListener;
import cn.qiyu.magicalcrue_patient.linkage.WheelAdapter;
...
public class WheelView extends View {
     ...
     */
    private final int ITEM_OFFSET = TEXT_SIZE / 8;
    ...
    private void initData(Context context) {
        ...
        LABEL_OFFSET = Utils.dip2px(context, LABEL_OFFSET_DIP);
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize(context.getResources().getDimension(R.dimen.text_size_normal));
...
//					| Paint.FAKE_BOLD_TEXT_FLAG | Paint.DITHER_FLAG);
            ...
            valuePaint.setTextSize(context.getResources().getDimension(R.dimen.text_size_normal));
