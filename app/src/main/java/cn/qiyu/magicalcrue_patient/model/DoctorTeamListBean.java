...
public class DoctorTeamListBean implements Serializable {
    ...
    public String getDoctor_name_pingyin() {
        return doctor_name_pingyin;
    }

    public void setDoctor_name_pingyin(String doctor_name_pingyin) {
        this.doctor_name_pingyin = doctor_name_pingyin;
    }
    ...
    public String getDoctor_name_jp() {
        return doctor_name_jp;
    }

    public void setDoctor_name_jp(String doctor_name_jp) {
        this.doctor_name_jp = doctor_name_jp;
    }
