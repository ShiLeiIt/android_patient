...
//            return "f1d4d544b4d2423691386b5f6963aac5";
        ...
        public void LoadOutPatientInfoList(ResultModel<List<DischargeBean>> model) {
            ListDischargeItemAdapter listDischargeItemAdapter = new ListDischargeItemAdapter(OutpatientInformationListActivity.this, OutpatientInformationListActivity.this, model.getData());
