 ...
 * blog: addapp.cn
 */
public class DateRemindPicker extends DateTimePicker {

    public DateRemindPicker(Activity activity) {
        this(activity, HOUR_12);
    }
     ...
     * @see #MONTH_DAY
     */
    public DateRemindPicker(Activity activity, @DateMode int mode) {
